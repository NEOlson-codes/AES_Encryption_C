/*
 ...
 Copyright   : N/A
 Date        : Feb 20, 2022
 Description : S-box is a look-up table used in transforms both during the
               rounds and to generate the key schedule. This header holds a
               2D array of the look-up values.
 ============================================================================
 */
 ...
 * row. Outputs are in hexadecimal format.
 */
uint32_t s_box[16][16] = {
